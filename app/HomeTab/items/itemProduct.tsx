...
const ItemHome = ({ imageSource, textContent, textPrice, textPriceSale, textDescription, navigation }: any) => {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.priceAndButton}>
        {textPrice && textPrice !== textPriceSale &&(
...
const styles = StyleSheet.create({
  ...
  priceSale: {
    ...
    color: '#000',
    marginBottom: 10,
    fontWeight: 'bold', // Make sale price bold
  },
  specialPrice: {
    fontSize: 18,
    color: '#ff0000', // Red for special price
    marginBottom: 10,
    fontWeight: 'bold', // Make special price bold
  },
  priceAndButton: {
    flexDirection: 'row', 
